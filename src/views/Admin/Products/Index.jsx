        ...
        <table className="w-full table-auto border border-stroke border-collapse overflow-x-auto rounded-sm bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
          <thead>
            <tr className="bg-gray-200 text-left dark:bg-meta-4">
              ...
              <th
                scope="col"
                className="py-4 px-4 font-medium text-black dark:text-white border border-stroke dark:border-strokedark w-[35%]"
              >
                Title
              </th>
              <th
                scope="col"
                className="py-4 px-4 font-medium text-black dark:text-white border border-stroke dark:border-strokedark sm:table-cell w-[10%]"
              >
                Owner
              </th>
              <th
              ...
              <th
                scope="col"
                className="py-4 px-4 font-medium text-black dark:text-white border border-stroke dark:border-strokedark md:table-cell w-[10%]"
              >
                Phone
              </th>
              <th
                scope="col"
                className="py-4 px-4 font-medium text-black dark:text-white border border-stroke dark:border-strokedark lg:table-cell w-[20%]"
              >
                Address
              </th>
              <th
            ...
            {products.length > 0 ? (
              products.map((product, index) => (
                ...
                >
                  ...
                  <td className="py-5 px-2 text-center text-sm font-medium text-black dark:text-white border border-stroke dark:border-strokedark lg:table-cell">
                    {product.address}
                  </td>
