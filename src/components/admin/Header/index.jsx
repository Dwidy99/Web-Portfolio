...
const Header = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-meta-4">
      <div className="flex flex-grow items-center px-4 py-4 shadow-2 xl:justify-end sm:justify-between md:px-6 2xl:px-11">
